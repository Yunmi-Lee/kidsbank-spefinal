    ...
    <section class="register-photo">
        <div class="form-container">
            <form id="register" method="post">
                ...
                <p class="info1" style="color: var(--gray-dark);">Please fill this form to create an account.</p>
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Sign Up</button></div><a class="already" href="login.php">Already have an account? Login here.</a>
            </form>
        </div>
    </section><a class="navbar-brand" href="index.html" style="text-align: left;"><i class="fa fa-child"></i>&nbsp;KIDS BANK</a>
