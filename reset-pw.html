    ...
    <section class="register-photo">
        <div class="form-container">
            <form id="register" method="post">
                ...
                <p class="info1" style="color: var(--gray-dark);">Please fill out this form to reset your password.</p><label>New Password</label>
                <div class="form-group"><input class="form-control" type="text" name="name" placeholder="Username"></div><label>Confirm Password</label>
