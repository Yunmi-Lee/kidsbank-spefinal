...
<body>
    <div>
        <nav class="navbar navbar-light navbar-expand-md text-right">
            <div class="container-fluid"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><a class="navbar-brand" href="index.html" style="text-align: left;"><i class="fa fa-child"></i>&nbsp;KIDS BANK</a></button>
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="navbar-nav text-right">
                        <li class="nav-item text-right"></li>
                        <li class="nav-item"><a class="nav-link" href="#">Second Item</a></li>
                        <li class="nav-item"></li>
                    </ul><a href="#">First Item</a><a href="#">Third Item</a>
                </div>
            </div>
        </nav>
    </div>
    <section class="register-photo">
        <div class="form-container">
            <form id="register" method="post">
                ...
                <p class="info1" style="color: var(--gray-dark);">Please fill in you credentials to login.</p>
                <label>Username</label>
                <div class="form-group"><input type="text" name="username" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
